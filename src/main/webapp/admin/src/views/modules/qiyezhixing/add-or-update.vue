          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工作事迹" prop="gongzuoshiji">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gongzuoshiji" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuoshiji" label="工作事迹" prop="gongzuoshiji">
                    <span v-html="ruleForm.gongzuoshiji"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwei = true;
            continue;
	            	            ...
	            	            if(o=='gongzuoshiji'){
            this.ruleForm.gongzuoshiji = obj[o];
	    this.ro.gongzuoshiji = true;
            continue;
          }
	            	            if(o=='faburiqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `qiyezhixing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiyezhixingCrossAddOrUpdateFlag = false;
                  this.parent.search();
