<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书馆名称" prop="tushuguanmingcheng">
          <el-input v-model="ruleForm.tushuguanmingcheng" 
              placeholder="图书馆名称" clearable  :readonly="ro.tushuguanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图书馆名称" prop="tushuguanmingcheng">
              <el-input v-model="ruleForm.tushuguanmingcheng" 
                placeholder="图书馆名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <el-form-item class="input" v-if="type!='info'"  label="图书类型" prop="tushuleixing">
          <el-input v-model="ruleForm.tushuleixing" 
              placeholder="图书类型" clearable  :readonly="ro.tushuleixing"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='tushuguanmingcheng'){
            this.ruleForm.tushuguanmingcheng = obj[o];
	    this.ro.tushuguanmingcheng = true;
            continue;
          }
	            	            if(o=='tushubianhao'){
