          ...
          <el-form-item class="input" label="招聘岗位" prop="zhaopingangwei">
              <el-input v-model="ruleForm.zhaopingangwei" 
                placeholder="招聘岗位" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工资" prop="gongzi">
          <el-input v-model="ruleForm.gongzi" 
              placeholder="工资" clearable  :readonly="ro.gongzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工资" prop="gongzi">
              <el-input v-model="ruleForm.gongzi" 
                placeholder="工资" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="应聘理由" prop="yingpinliyou">
          <el-input v-model="ruleForm.yingpinliyou" 
              placeholder="应聘理由" clearable  :readonly="ro.yingpinliyou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="应聘理由" prop="yingpinliyou">
              <el-input v-model="ruleForm.yingpinliyou" 
                placeholder="应聘理由" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
  ...
  data() {
	...
	shhf : false,
            ...
            ruleForm: {
                  ...
                  yingpinliyou: [
                            { required: true, message: '应聘理由不能为空', trigger: 'blur' },
                                    	                                                              ],
                  jianlitoudi: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopingangwei = true;
            continue;
	            	            ...
	            	            if(o=='gongzi'){
            this.ruleForm.gongzi = obj[o];
	    this.ro.gongzi = true;
            continue;
          }
	            	            if(o=='yingpinliyou'){
            this.ruleForm.yingpinliyou = obj[o];
	    this.ro.yingpinliyou = true;
            continue;
          }
	            	            if(o=='jianlitoudi'){
