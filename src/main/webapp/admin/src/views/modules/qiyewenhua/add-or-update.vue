        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="视频简介" prop="shipinjianjie">
          <file-upload
          tip="点击上传视频简介"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shipinjianjie?ruleForm.shipinjianjie:''"
          @change="shipinjianjieUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.shipinjianjie" label="视频简介" prop="shipinjianjie">
            <el-button type="text" size="small" @click="download(ruleForm.shipinjianjie)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
                                                                                                <el-col :span="12">
          ...
          <el-form-item class="input" label="详细地址" prop="xiangxidizhi">
              <el-input v-model="ruleForm.xiangxidizhi" 
                placeholder="详细地址" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="企业文化" prop="qiyewenhua">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="企业文化"
                  v-model="ruleForm.qiyewenhua" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiyewenhua" label="企业文化" prop="qiyewenhua">
                    <span>{{ruleForm.qiyewenhua}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="发展历史" prop="fazhanlishi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.fazhanlishi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fazhanlishi" label="发展历史" prop="fazhanlishi">
                    <span v-html="ruleForm.fazhanlishi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shipinjianjie = true;
            continue;
	            	            ...
	            	            if(o=='qiyewenhua'){
            this.ruleForm.qiyewenhua = obj[o];
	    this.ro.qiyewenhua = true;
            continue;
          }
	            	            if(o=='fazhanlishi'){
            this.ruleForm.fazhanlishi = obj[o];
	    this.ro.fazhanlishi = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `qiyewenhua/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiyewenhuaCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                ...
                                shipinjianjieUploadChange(fileUrls) {
                this.ruleForm.shipinjianjie = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                        	addEditStyleChange() {
	  this.$nextTick(()=>{
