          ...
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="招聘要求" prop="zhaopinyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="招聘要求"
                  v-model="ruleForm.zhaopinyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhaopinyaoqiu" label="招聘要求" prop="zhaopinyaoqiu">
                    <span>{{ruleForm.zhaopinyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
