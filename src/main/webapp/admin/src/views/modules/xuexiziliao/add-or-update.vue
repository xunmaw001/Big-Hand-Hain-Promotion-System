        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xuexiziliao" label="学习资料" prop="xuexiziliao">
            <el-button type="text" size="small" @click="download(ruleForm.xuexiziliao)">下载</el-button>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="学习视频" prop="xuexishipin">
          <file-upload
          tip="点击上传学习视频"
          action="file/upload"
          :limit="1"
          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="内容简介" prop="neirongjianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="内容简介"
                  v-model="ruleForm.neirongjianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.neirongjianjie" label="内容简介" prop="neirongjianjie">
                    <span>{{ruleForm.neirongjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuexishipin = true;
            continue;
	            	            ...
	            	            if(o=='neirongjianjie'){
            this.ruleForm.neirongjianjie = obj[o];
	    this.ro.neirongjianjie = true;
            continue;
          }
	            	            if(o=='faburiqi'){
